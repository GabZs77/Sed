...
const PDF_PROXY_URL = `${WORKER_URL}/pdf`;
...
function apostilaUrl(repoPath, file) { const path = `${repoPath}/${file}`; return `${PDF_PROXY_URL}?path=${encodeURIComponent(path)}`; }
